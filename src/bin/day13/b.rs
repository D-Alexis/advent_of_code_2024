...
fn find(claw: &Claw) -> i64 {
    ...
    let j = (claw.price.1 * claw.button_a.0 - claw.price.0 * claw.button_a.1) as f64
        / (claw.button_a.0 * claw.button_b.1 - claw.button_b.0 * claw.button_a.1) as f64;
    if j.floor() - j == 0.0 {
    ...
    input
        ...
        .map(|claw| {
            ...
            Claw {
                ...
                price: (list[2].0 + 10000000000000, list[2].1 + 10000000000000),
            }
        })
        .collect::<Vec<Claw>>()
}
